...
export const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen" data-testid="profile-page">
          ...
          <div className="px-6 pb-6">
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4 -mt-10 sm:-mt-12">
              ...
              <div className="flex-1">
                ...
                <p
                  className={`text-sm font-medium capitalize ${getRoleColor(user?.role)}`}
                >
                  {user?.role?.replace("_", " ")}
                </p>
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-4 p-4 bg-zinc-950 rounded-lg">
              ...
              <div className="flex-1">
                ...
                <p
                  className={`font-medium capitalize ${getRoleColor(user?.role)}`}
                >
                  {user?.role?.replace("_", " ")}
                </p>
              </div>
      ...
      <Dialog
        open={passwordModal}
        onOpenChange={(o) => !o && setPasswordModal(false)}
      >
        <DialogContent className="bg-zinc-900 border-zinc-800">
          <DialogHeader>
